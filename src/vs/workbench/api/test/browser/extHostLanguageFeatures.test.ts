...
suite('ExtHostLanguageFeatures', function () {
	...
	test('Selection Ranges, data conversion', async () => {
		...
		provideSelectionRanges(languageFeaturesService.selectionRangeProvider, model, [new Position(1, 17)], { selectLeadingAndTrailingWhitespace: true }, false, CancellationToken.None).then(ranges => {
